...
class Locations extends Component {
        ...
        console.log(this.props.match.url.split("locations")[0])
        return <div className="map container"><h3>{map_chosen[0][0]}</h3><iframe src={map_chosen[0][2]} width="100%" height="100%" frameBorder="0" allowFullScreen></iframe></div>
      }
  render() {
    return (
      <div className="locations-body-container"><div className="locations-body">
        <a className="back-button" href={`#${this.props.match.url.split("/locations")[0]}`}>Back</a>
        {this.displayMaps()}
      </div></div>
    );
  }
